...
#define kOKButtonTitleColorNormal    ([UIColor colorWithRed:(255/255.0) green:(62/255.0) blue:(63/255.0) alpha:1.0])
#define kOKButtonTitleColorDisabled  ([UIColor colorWithRed:(255/255.0) green:(62/255.0) blue:(63/255.0) alpha:0.5])
