...
typedef void (^ZBLM3u8DownloadCompletaionHandler)(NSString *locaLUrl,NSError *error,NSString *oriUrl);
typedef void (^ZBLM3u8DownloadProgressHandler)(float progress,NSString *oriUrl);
