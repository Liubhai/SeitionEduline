...
#define KHWCircleLineWidth 3
#define KHWCircleFont [UIFont boldSystemFontOfSize:12.0]
...
-(void)layoutSubviews{
    ...
    _cLabel.center = CGPointMake(self.bounds.size.width / 2.0, self.bounds.size.height / 2.0);
}
