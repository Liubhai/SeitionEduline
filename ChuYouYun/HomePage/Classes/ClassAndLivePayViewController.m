...
- (void)addClassInformationView {
    ...
    price.text = [NSString stringWithFormat:@"金豆%@",[_dict stringValueForKey:@"price"]];
    if (SWNOTEmptyDictionary(_activityInfo)) {
        NSString *eventType = [NSString stringWithFormat:@"%@",[[_activityInfo objectForKey:@"event_type_info"] objectForKey:@"type_code"]];
        if ([eventType integerValue] == 6 && [[_activityInfo objectForKey:@"is_start"] integerValue] == 1 && _isBuyAlone) {
            price.text = [NSString stringWithFormat:@"金豆 %@",[[_dict objectForKey:@"mz_price"] objectForKey:@"selPrice"]];
            if (_isJoinGroup) {
                price.text = [NSString stringWithFormat:@"金豆 %@",[_activityInfo objectForKey:@"event_price_other"]];
            } else {
                price.text = [NSString stringWithFormat:@"金豆 %@",[_activityInfo objectForKey:@"event_price"]];
            }
        }
    }
    if (_cellDict != nil) {//单课时解锁
        price.text = [NSString stringWithFormat:@"金豆%@",[_cellDict stringValueForKey:@"course_hour_price"]];
    }
...
//        residue.text = @"100";
        ...
        _residue = residue;
        _residue.text = [NSString stringWithFormat:@"(当前金豆%@)",[_userBalanceDict stringValueForKey:@"learn" defaultValue:@"0"]];
...
//    _entityGoToUseButton = entityGoToUseButton;
    ...
    if ([_typeStr integerValue] == 3 || (_alipayView.height == 0 && _wxpayView.height == 0 && _balanceView.height != 0)) {
...
- (void)addMoneyView {
    ...
    for (int i = 0 ; i < 2 ; i ++) {
        ...
        if (i == 0) {//原价
            moneyLabel.text = [NSString stringWithFormat:@"金豆%@",[_dict stringValueForKey:@"price"]];
            if (SWNOTEmptyDictionary(_activityInfo)) {
                NSString *eventType = [NSString stringWithFormat:@"%@",[[_activityInfo objectForKey:@"event_type_info"] objectForKey:@"type_code"]];
                if ([eventType integerValue] == 6 && [[_activityInfo objectForKey:@"is_start"] integerValue] == 1 && _isBuyAlone) {
                    moneyLabel.text = [NSString stringWithFormat:@"金豆 %@",[[_dict objectForKey:@"mz_price"] objectForKey:@"selPrice"]];
                    if (_isJoinGroup) {
                        moneyLabel.text = [NSString stringWithFormat:@"金豆 %@",[_activityInfo objectForKey:@"event_price_other"]];
                    } else {
                        moneyLabel.text = [NSString stringWithFormat:@"金豆 %@",[_activityInfo objectForKey:@"event_price"]];
                    }
                }
            }
            if (_cellDict != nil) {
                 moneyLabel.text = [NSString stringWithFormat:@"金豆%@",[_cellDict stringValueForKey:@"course_hour_price"]];
            }
        } else {//优惠
            _discountMoneyLabel = moneyLabel;
            _discountMoneyLabel.text = @"-金豆0.0";
        }
...
- (void)addDownView {
    ...
    realMoney.text = [NSString stringWithFormat:@"金豆%@",[_dict stringValueForKey:@"price"]];
    if (SWNOTEmptyDictionary(_activityInfo)) {
        NSString *eventType = [NSString stringWithFormat:@"%@",[[_activityInfo objectForKey:@"event_type_info"] objectForKey:@"type_code"]];
        if ([eventType integerValue] == 6 && [[_activityInfo objectForKey:@"is_start"] integerValue] == 1 && _isBuyAlone) {
            realMoney.text = [NSString stringWithFormat:@"金豆 %@",[[_dict objectForKey:@"mz_price"] objectForKey:@"selPrice"]];
            if (_isJoinGroup) {
                realMoney.text = [NSString stringWithFormat:@"金豆 %@",[_activityInfo objectForKey:@"event_price_other"]];
            } else {
                realMoney.text = [NSString stringWithFormat:@"金豆 %@",[_activityInfo objectForKey:@"event_price"]];
            }
        }
    }
    if (_cellDict != nil) {
        realMoney.text = [NSString stringWithFormat:@"金豆%@",[_cellDict stringValueForKey:@"course_hour_price"]];
    }
...
- (void)getDiscount:(NSNotification *)not {
    ...
    if ([[dict stringValueForKey:@"type"] integerValue] == 1) {//优惠券
        ...
        _discountMoneyLabel.text = [NSString stringWithFormat:@"-金豆%@",[dict stringValueForKey:@"price"]];
        ...
        _realMoney.text = [NSString stringWithFormat:@"金豆%1f",money1 - discount1];
        NSString *money2 = [NSString stringWithFormat:@"金豆%.2f",money1 - discount1];
        ...
        _realMoney.text = [NSString stringWithFormat:@"金豆%1f",money1 * discount1 / 10];
        NSString *money2 = [NSString stringWithFormat:@"金豆%.2f",money1 * discount1 / 10];
        _realMoney.text = money2;
        _discountMoneyLabel.text = [NSString stringWithFormat:@"-金豆%.2f",[[_dict stringValueForKey:@"price"] floatValue] - money1 * discount1 / 10];
        if (SWNOTEmptyDictionary(_activityInfo)) {
            NSString *eventType = [NSString stringWithFormat:@"%@",[[_activityInfo objectForKey:@"event_type_info"] objectForKey:@"type_code"]];
            if ([eventType integerValue] == 6 && [[_activityInfo objectForKey:@"is_start"] integerValue] == 1 && _isBuyAlone) {
                _discountMoneyLabel.text = [NSString stringWithFormat:@"-金豆%.2f",[[NSString stringWithFormat:@"%@",[[_dict objectForKey:@"mz_price"] objectForKey:@"selPrice"]] floatValue] - money1 * discount1 / 10];
            }
        }
        ...
        _realMoney.text = @"0金豆";
        _discountMoneyLabel.text = [NSString stringWithFormat:@"-金豆%@",[_dict stringValueForKey:@"price"]];
        if (SWNOTEmptyDictionary(_activityInfo)) {
            NSString *eventType = [NSString stringWithFormat:@"%@",[[_activityInfo objectForKey:@"event_type_info"] objectForKey:@"type_code"]];
            if ([eventType integerValue] == 6 && [[_activityInfo objectForKey:@"is_start"] integerValue] == 1 && _isBuyAlone) {
                _discountMoneyLabel.text = [NSString stringWithFormat:@"-金豆%@",[[_dict objectForKey:@"mz_price"] objectForKey:@"selPrice"]];
            }
        }
    }
...
- (void)getEntityCardUse:(NSNotification *)not {
    ...
    if (_entityReturnDict == nil) {
        ...
        _discountMoneyLabel.text = [NSString stringWithFormat:@"-金豆0.0"];
        _realMoney.text = [NSString stringWithFormat:@"金豆%@",[_dict stringValueForKey:@"price"]];
        if (SWNOTEmptyDictionary(_activityInfo)) {
            NSString *eventType = [NSString stringWithFormat:@"%@",[[_activityInfo objectForKey:@"event_type_info"] objectForKey:@"type_code"]];
            if ([eventType integerValue] == 6 && [[_activityInfo objectForKey:@"is_start"] integerValue] == 1 && _isBuyAlone) {
                _realMoney.text = [NSString stringWithFormat:@"金豆%@",[[_dict objectForKey:@"mz_price"] objectForKey:@"selPrice"]];
            }
        }
        return;
    }
...
//    _entityGoToUseButton.backgroundColor = [UIColor redColor];
    ...
    if ([[_entityReturnDict stringValueForKey:@"type"] integerValue] == 1) {//优惠券
        ...
        _discountMoneyLabel.text = [NSString stringWithFormat:@"-金豆%@",[_entityReturnDict stringValueForKey:@"price"]];
        CGFloat money1 = [[_dict stringValueForKey:@"price"] floatValue];
        if (SWNOTEmptyDictionary(_activityInfo)) {
            NSString *eventType = [NSString stringWithFormat:@"%@",[[_activityInfo objectForKey:@"event_type_info"] objectForKey:@"type_code"]];
            if ([eventType integerValue] == 6 && [[_activityInfo objectForKey:@"is_start"] integerValue] == 1 && _isBuyAlone) {
        ...
        _realMoney.text = [NSString stringWithFormat:@"金豆%2f",money1 - discount1];
        NSString *money2 = [NSString stringWithFormat:@"金豆%.2f",money1 - discount1];
        _realMoney.text = money2;
