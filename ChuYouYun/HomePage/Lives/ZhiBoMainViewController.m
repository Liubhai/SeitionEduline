...
- (void)addDownView {
    ...
    NSArray *titleArray = @[[NSString stringWithFormat:@"马币 %@",[_zhiBoDic stringValueForKey:@""]],@"立即解锁"];
...
- (void)ordPriceDeal {
    ...
    _ordPrice.text = [NSString stringWithFormat:@"%@马币",[_zhiBoDic stringValueForKey:@"v_price"]];
...
- (void)netWorkLiveGetInfo_After {
    ...
    _priceLabel.text = [NSString stringWithFormat:@"马币%@",[_zhiBoDic stringValueForKey:@"price"]];
    NSString *nowPrice = [NSString stringWithFormat:@"马币 %@",[_zhiBoDic stringValueForKey:@"price"]];
    if (SWNOTEmptyDictionary(_activityInfo)) {
        ...
        if ([eventType integerValue] == 6) {
            nowPrice = [NSString stringWithFormat:@"马币 %@",[[_zhiBoDic objectForKey:@"mz_price"] objectForKey:@"selPrice"]];
        }
    }
    NSString *oldPrice = [NSString stringWithFormat:@"马币%@",[_zhiBoDic stringValueForKey:@"v_price"]];
...
- (void)changeEventPriceUI {
    if (SWNOTEmptyDictionary(_zhiBoDic) && SWNOTEmptyDictionary(_activityInfo)) {
        ...
        if ([eventType integerValue] == 6) {
            ...
            if (SWNOTEmptyDictionary(_zhiBoDic)) {
                priceCount = [NSString stringWithFormat:@"%@马币",[[_zhiBoDic objectForKey:@"mz_price"] objectForKey:@"eprice"]];
                discount = [NSString stringWithFormat:@"%@马币",[[_zhiBoDic objectForKey:@"mz_price"] objectForKey:@"selPrice"]];
                NSString *nowPrice = [NSString stringWithFormat:@"马币 %@",[_zhiBoDic stringValueForKey:@"price"]];
                NSString *oldPrice = [NSString stringWithFormat:@"马币%@",[_zhiBoDic stringValueForKey:@"v_price"]];
                if ([[_activityInfo objectForKey:@"is_start"] integerValue] == 1) {
                    oldPrice = discount;
