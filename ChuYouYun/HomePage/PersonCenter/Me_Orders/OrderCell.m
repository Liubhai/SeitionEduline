...
//    imageUrl = [dict stringValueForKey:@"cover"];
    ...
    _realPrice.text = [NSString stringWithFormat:@"马币 %@",[dict stringValueForKey:@"price"]];
//    _price.text = [NSString stringWithFormat:@"马币 %@",[[[dict dictionaryValueForKey:@"source_info"] dictionaryValueForKey:@"mzprice"] stringValueForKey:@"oriPrice"]];
...
//            _price.text = [NSString stringWithFormat:@"马币 %@",[dict stringValueForKey:@"price"]];
    ...
    [_headerImage setWidth:100];
    [_name setLeft:120];
    [_price setLeft:120];
    if ([orderTypeStr integerValue] == 6) {
        [_headerImage setWidth:0];
        [_name setLeft:SpaceBaside];
        [_price setLeft:SpaceBaside];
    }
