...
- (void)addMYView {
    ...
    if ([MoreOrSingle integerValue] == 1) {//单机构
        ...
        if ([HASALIPAY isEqualToString:@"0"]) {
            if ([_isTeacher integerValue] == 1) {
                SYGArray = @[@"我的课程",@"我的收藏",@"学习记录",@"我的授课",@"我的线下课",@"线下课管理",@"我的提问",@"我的点评",@"讲师认证"];
                TBArray = @[@"live@3x",@"collect@3x",@"study@3x",@"me_is_teacher",@"me_is_teacher",@"me_is_teacher",@"question",@"comment",@"teacher"];
            } else {
                SYGArray = @[@"我的课程",@"我的收藏",@"学习记录",@"我的线下课",@"我的提问",@"我的点评"];
                TBArray = @[@"live@3x",@"collect@3x",@"study@3x",@"me_is_teacher",@"question",@"comment",];
            }
        } else {
            if ([_isTeacher integerValue] == 1) {
                SYGArray = @[@"我的课程",@"我的收藏",@"我的卡券",@"学习记录",@"我的授课",@"我的线下课",@"线下课管理",@"我的提问",@"我的点评",@"讲师认证"];
                TBArray = @[@"live@3x",@"collect@3x",@"conpons@3x",@"study@3x",@"me_is_teacher",@"me_is_teacher",@"me_is_teacher",@"question",@"comment",@"teacher"];
            } else {
                SYGArray = @[@"我的课程",@"我的收藏",@"我的卡券",@"学习记录",@"我的线下课",@"我的提问",@"我的点评"];
                TBArray = @[@"live@3x",@"collect@3x",@"conpons@3x",@"study@3x",@"me_is_teacher",@"question",@"comment",];
            }
        }
    }
