...
#pragma mark --- 添加视图
- (void)addAilpay {
    UILabel *title = [[UILabel alloc] initWithFrame:CGRectMake(10 * WideEachUnit, MACRO_UI_UPHEIGHT , MainScreenWidth, 40 * WideEachUnit)];
    title.text = @"支付宝账号";
    ...
    //添加输入框
    UITextField *aliTextField = [[UITextField alloc] initWithFrame:CGRectMake(0, MACRO_UI_UPHEIGHT + 40 * WideEachUnit, MainScreenWidth, 50 * WideEachUnit)];
    ...
    //切换账号
    UIButton *changeButton = [[UIButton alloc] initWithFrame:CGRectMake(10 * WideEachUnit, MACRO_UI_UPHEIGHT + 100 * WideEachUnit, 100 * WideEachUnit, 30 * WideEachUnit)];
    ...
    //解除绑定
    UIButton *relieveButton = [[UIButton alloc] initWithFrame:CGRectMake(MainScreenWidth - 120 * WideEachUnit, MACRO_UI_UPHEIGHT + 100 * WideEachUnit, 100 * WideEachUnit, 30 * WideEachUnit)];
