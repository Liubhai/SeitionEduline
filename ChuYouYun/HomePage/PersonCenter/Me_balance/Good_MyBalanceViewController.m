...
- (void)addRechargeView {
    ...
    [_applePayView setTop:CGRectGetMaxY(_rechargeView.frame) + 10 * WideEachUnit];
    [_agreeView setTop:CGRectGetMaxY(_applePayView.frame) + 10 * WideEachUnit];
}

- (void)addApplePayView {
    if (_applePayView == nil) {
        _applePayView = [[UIView alloc] initWithFrame:CGRectMake(0 * WideEachUnit, CGRectGetMaxY(_rechargeView.frame) + 10 * WideEachUnit, MainScreenWidth, 50 * WideEachUnit)];
...
- (void)addAgreeView {
    if (_agreeView == nil) {
        _agreeView = [[UIView alloc] initWithFrame:CGRectMake(0 * WideEachUnit, CGRectGetMaxY(_applePayView.frame) + 10 * WideEachUnit, MainScreenWidth - 0 * WideEachUnit, 44 * WideEachUnit)];
