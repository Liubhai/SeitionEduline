...
//
        ...
        if ([_scoreStaus integerValue] == 0) {
             textStr = [NSString stringWithFormat:@"金豆%.2f",[[[_rankArray objectAtIndex:i] stringValueForKey:@"price"] floatValue]  * percentage];
        }
        person.text = textStr;
        person.font = Font(11);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    for (int i = 0; i < _dataArray.count ; i++) {
        ...
        if ([_scoreStaus integerValue] == 0) {
            integral.text = [NSString stringWithFormat:@"%.2f金豆",[[[_dataArray objectAtIndex:i] stringValueForKey:@"price"] floatValue]  * percentage];
        }
