...
- (void)makeSubView {
    ...
    _tipLabel.text = [NSString stringWithFormat:@"注:金豆与积分的兑换比例为1:%@",@(1 / _percentage)];
    ...
    _payCountLabel.text = [NSString stringWithFormat:@"金豆%.2f",Money];
