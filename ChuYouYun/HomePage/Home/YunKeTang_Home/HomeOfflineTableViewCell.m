...
- (void)setOfflineInfo:(NSDictionary *)dict order_switch:(NSString *)order_switch {
    ...
    if ([[dict stringValueForKey:@"price"] floatValue] == 0) {
        ...
        NSString *t_price = [NSString stringWithFormat:@"%@金豆",[dict stringValueForKey:@"t_price"]];
        _priceLabel.text = [NSString stringWithFormat:@"%@金豆 %@",[dict stringValueForKey:@"price"],t_price];
...
//                _priceLabel.textColor = [UIColor colorWithHexString:@"#47b37d"];
//            } else {
//                _priceLabel.text = [NSString stringWithFormat:@"%@金豆",[dict stringValueForKey:@"price"]];
//                _priceLabel.textColor = PriceColor;
//            }
//        }
//    } else {
