...
- (void)addDownView {
    ...
    lab1.text = [NSString stringWithFormat:@"在线学习：%@ 金豆",_lineonPrice];
    if (_lineonPrice == nil) {
        lab1.text = @"线上学习：0.00 金豆";
    }
    ...
    lab2.text = [NSString stringWithFormat:@"线下学习：%@ 金豆",_lineoffprice];
    if (_lineoffprice == nil) {
        lab2.text = @"线下学习：0.00 金豆";
    }
