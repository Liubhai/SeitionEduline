...
/// 测试服(d单机构和多机构)
#define EncryptUrl [MoreOrSingle_HeaderUrl integerValue] == 1 ? @"https://single.51eduline.com/service/" : @"https://test.jingtuxueyuan.com/service/"
#define EncryptHeaderUrl [MoreOrSingle_HeaderUrl integerValue] == 1 ? @"https://single.51eduline.com" : @"https://test.jingtuxueyuan.com"

#define basidUrl [MoreOrSingle_HeaderUrl integerValue] == 1 ? @"https://single.51eduline.com/service" : @"https://test.jingtuxueyuan.com/service"
...
// 微信分享
#define WXAppId @"wx059562472b73b5d9"
#define WXAppSecret @"8923ef7e0aab228821f47599eb343f12"
// QQ分享
#define QQAppId @"101491822"
#define QQAppSecret @"63497e1782ffad4908ad63b908156d69"
// 新浪分享
#define SinaAppId @"3997129963"
#define SinaAppSecret @"da07bcf6c9f30281e684f8abfd0b4fca"

// 支付宝h5支付之后需要回到app
#define AlipayBundleId @"com.jtjy.jtxy"
