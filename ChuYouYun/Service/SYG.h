...
/// 测试服(d单机构和多机构)
#define EncryptUrl [MoreOrSingle_HeaderUrl integerValue] == 1 ? @"https://single.51eduline.com/service/" : @"http://www.zhiyejineng.com/service/"
#define EncryptHeaderUrl [MoreOrSingle_HeaderUrl integerValue] == 1 ? @"https://single.51eduline.com" : @"http://www.zhiyejineng.com"

#define basidUrl [MoreOrSingle_HeaderUrl integerValue] == 1 ? @"https://single.51eduline.com/service" : @"http://www.zhiyejineng.com/service"
...
// 支付宝h5支付之后需要回到app
#define AlipayBundleId @"com.ezhixue.app"
