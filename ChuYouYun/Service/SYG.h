...
/// 测试服(d单机构和多机构)
#define EncryptUrl [MoreOrSingle_HeaderUrl integerValue] == 1 ? @"http://edu.jintuoo.com/service/" : @"https://www.kuajingedu.com/service/"
#define EncryptHeaderUrl [MoreOrSingle_HeaderUrl integerValue] == 1 ? @"http://edu.jintuoo.com" : @"https://www.kuajingedu.com"

#define basidUrl [MoreOrSingle_HeaderUrl integerValue] == 1 ? @"http://edu.jintuoo.com/service" : @"https://www.kuajingedu.com/service"
...
// 微信分享
#define WXAppId @"wx10ae0bb201a2c632"
#define WXAppSecret @"17740bf81da0bf838656426f2c6dd292"
// QQ分享
#define QQAppId @"101735846"
#define QQAppSecret @"d36d09a6a6451c91d341c00a586ac5f6"
// 新浪分享
#define SinaAppId @"3997129963"
#define SinaAppSecret @"da07bcf6c9f30281e684f8abfd0b4fca"

// 支付宝h5支付之后需要回到app
#define AlipayBundleId @"com.tenglima.jiaoyu"
