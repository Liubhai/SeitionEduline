...
/// 测试服(d单机构和多机构)
#define EncryptUrl [MoreOrSingle_HeaderUrl integerValue] == 1 ? @"http://创远职业技能.top/service/" : @"https://t.v4.51eduline.com/service/"
#define EncryptHeaderUrl [MoreOrSingle_HeaderUrl integerValue] == 1 ? @"http://创远职业技能.top" : @"https://t.v4.51eduline.com"

#define basidUrl [MoreOrSingle_HeaderUrl integerValue] == 1 ? @"http://创远职业技能.top/service" : @"https://t.v4.51eduline.com/service"
...
// 支付宝h5支付之后需要回到app
#define AlipayBundleId @"com.chuangyuang.jineng"
