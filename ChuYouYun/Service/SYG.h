...
/// 测试服(d单机构和多机构)
#define EncryptUrl [MoreOrSingle_HeaderUrl integerValue] == 1 ? @"https://single.51eduline.com/service/" : @"https://www.zhongbke.com/service/"
#define EncryptHeaderUrl [MoreOrSingle_HeaderUrl integerValue] == 1 ? @"https://single.51eduline.com" : @"https://www.zhongbke.com"

#define basidUrl [MoreOrSingle_HeaderUrl integerValue] == 1 ? @"https://single.51eduline.com/service" : @"https://www.zhongbke.com/service"
...
// 微信分享
#define WXAppId @"wxb2a352cabaa82c92"
#define WXAppSecret @"5d89e129bc1b9877be29035b0663a0ed"
// QQ分享
...
// 支付宝h5支付之后需要回到app
#define AlipayBundleId @"com.zhongbke.zhongbke"
