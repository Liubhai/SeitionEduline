...
/// 测试服(d单机构和多机构)
#define EncryptUrl [MoreOrSingle_HeaderUrl integerValue] == 1 ? @"https://single.51eduline.com/service/" : @"http://ndfedu.51eduline.com/service/"
#define EncryptHeaderUrl [MoreOrSingle_HeaderUrl integerValue] == 1 ? @"https://single.51eduline.com" : @"http://ndfedu.51eduline.com"

#define basidUrl [MoreOrSingle_HeaderUrl integerValue] == 1 ? @"https://single.51eduline.com/service" : @"http://ndfedu.51eduline.com/service"
...
// 微信分享
#define WXAppId @"wxa4e189d74066943f"
#define WXAppSecret @"e91ee3000b21c214a4c16ae4fbafbdc4"
// QQ分享
...
// 支付宝h5支付之后需要回到app
#define AlipayBundleId @"com.niendorf.meiyueyunketang"
