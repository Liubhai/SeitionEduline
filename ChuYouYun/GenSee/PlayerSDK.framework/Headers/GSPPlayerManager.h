...
typedef NS_ENUM(NSInteger, GSPPayType) {
 ...
 */
- (void)rewardMoney:(unsigned)money comment:(NSString*)comment payType:(GSPPayType)payType expireTime:(NSUInteger)expireTime extra:(NSString*)extra;
