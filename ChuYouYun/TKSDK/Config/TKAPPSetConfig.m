...
//    }
    ...
    [[BITHockeyManager sharedHockeyManager].crashManager setAlertViewHandler:^{
        TKAlertView *alert = [[TKAlertView alloc]initWithTitle:MTLocalized(@"Prompt.ExceptionReport") contentText:MTLocalized(@"Prompt.AbnormalityReport") leftTitle:MTLocalized(@"Prompt.Cancel") rightTitle:MTLocalized(@"Button.send")];
        alert.rightBlock = ^{
