...
// global11
//static  NSString * sHost   = @"global11.talk-cloud.com";

//用户昵称\房间号\老师密码 (用于测试数据\ 注释后将读取输入的信息)
#if DEBUG

//#define Class_NickName         @"肉丸"
//#define SERVER_ClassID         @"143912756"
...
#define BUNDLE_NAME @ "TKResources.bundle"
...
// 自定义
static  NSString *const sInOnlyAudioRoom     		= @"isOnlyAudioRoom";
...
// 公司定义
//static  NSString *const YLB_COMPANYID                 = @"10035";// 英练帮公司id
