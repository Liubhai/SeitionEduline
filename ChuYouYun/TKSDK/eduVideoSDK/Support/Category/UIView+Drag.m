...
//            //由center_x,center_y 转化为 x，y
//            CGFloat new_x = x - self.mg_width/2;
//            CGFloat new_y = y - self.mg_height/2;
//            
//            CGFloat percent_x = (x - self.mg_width/2) / (self.superview.mg_width);
//            CGFloat percent_y = (y - self.mg_height/2) / (self.superview.mg_height);
//            
//            [self mas_remakeConstraints:^(MASConstraintMaker *make) {
//                
//                if (new_x == 0) {
//                    make.left.equalTo(self.superview.mas_left);
//                }else  if (new_x >= self.superview.mg_width - self.mg_width) {
//                    make.right.equalTo(self.superview.mas_right);
//                }else{
//                    make.left.equalTo(self.superview.mas_right).multipliedBy(percent_x);
//                }
//                
//                if (new_y == 0) {
//                    make.top.equalTo(self.superview.mas_top);
//                }else if (new_y >= self.superview.mg_height - self.mg_height){
//                    make.bottom.equalTo(self.superview.mas_bottom);
//                }else{
//                    make.top.equalTo(self.superview.mas_bottom).multipliedBy(percent_y);
//                }
//                
//            }];
...
//            else{
                ...
                if (gesR.view.mg_centerX + self.superview.mg_x > self.superview.mg_centerX) { // 右边 居右
                    CGPoint deltaCenter = CGPointMake(self.superview.mg_width - self.mg_width / 2 - self.superview.width / 2, y - self.superview.height / 2);
                    [self mas_remakeConstraints:^(MASConstraintMaker *make) {
                        make.left.equalTo(self.superview.mas_left).offset(deltaCenter.x + self.superview.frame.size.width / 2 - self.frame.size.width /2);
                        make.top.equalTo(self.superview.mas_top).offset(deltaCenter.y + self.superview.frame.size.height / 2 - self.frame.size.height /2);
                    }];
...
//                        gesR.view.center = CGPointMake(self.superview.mg_width - self.mg_width / 2, y);
                    ...
                    CGPoint deltaCenter = CGPointMake(self.mg_width / 2 - self.superview.width / 2, y - self.superview.height / 2);
                    [self mas_remakeConstraints:^(MASConstraintMaker *make) {
                        make.left.equalTo(self.superview.mas_left).offset(deltaCenter.x + self.superview.frame.size.width / 2 - self.frame.size.width /2);
                        make.top.equalTo(self.superview.mas_top).offset(deltaCenter.y + self.superview.frame.size.height / 2 - self.frame.size.height /2);
                    }];
