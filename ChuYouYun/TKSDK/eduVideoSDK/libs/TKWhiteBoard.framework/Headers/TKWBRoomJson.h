...
@interface TKWBRoomJson : NSObject
...
/**
 配置项
 */
@property (nonatomic, strong)TKWBRoomConfiguration *configuration;
...
//配置项
@interface TKWBRoomConfiguration : NSObject
...
/**
 答题结束后自动展示答案(此配置项 iOS老师端 结束答题后 是否显示公布答案的按钮)
 */
