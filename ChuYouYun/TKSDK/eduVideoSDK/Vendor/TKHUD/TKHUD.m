...
-(void)showAtView:(UIView *)view hudType:(TKHUDLoadingType)hudType
{
    ...
    if (hudType == TKHUDLoadingTypeCustomAnimations) {
        ...
        for (int index = 0; index<=11; index++) {
            ...
            NSString * imageName;
            if (index<10) {
                NSString *str = [TKTheme stringWithPath:@"Loading.LoadingImage"];
                
                imageName = [NSString stringWithFormat:@"%@%d.png",str,index];
            }else{
                
                NSString *str = [TKTheme stringWithPath:@"Loading.LoadingImage2"];
        ...
        NSString *str = [TKTheme stringWithPath:@"Loading.LoadingGigImage"];
