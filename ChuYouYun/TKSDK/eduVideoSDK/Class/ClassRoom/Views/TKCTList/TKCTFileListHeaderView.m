...
- (instancetype)initWithFrame:(CGRect)frame fileType:(BOOL)type{
    if (self = [super initWithFrame:frame]) {
        ...
        _classFileButton = ({
            ...
            [button setTitle:MTLocalized(@"Title.ClassroomDocuments") forState:UIControlStateNormal];
        ...
        _systemFileButton = ({
            ...
            [button setTitle:MTLocalized(@"Title.PublicDocuments") forState:UIControlStateNormal];
        ...
        _nameSortBtn = ({
            ...
            [button setTitle:MTLocalized(@"Button.nameSort") forState:(UIControlStateNormal)];
        ...
        _typeSortBtn = ({
            ...
            button.sakura.titleColor(ThemeKP(@"listSortColor"),UIControlStateNormal);
            [button setTitle:MTLocalized(@"Button.typeSort") forState:(UIControlStateNormal)];
            button.titleLabel.font = _classFileButton.titleLabel.font;
            button.sakura.image(ThemeKP(@"arrange_none"),UIControlStateNormal);
        ...
        _timeSortBtn = ({
            ...
            button.centerY = _nameSortBtn.centerY;
            button.sakura.titleColor(ThemeKP(@"listSortColor"),UIControlStateNormal);
            [button setTitle:MTLocalized(@"Button.timeSort") forState:(UIControlStateNormal)];
            button.titleLabel.font = _classFileButton.titleLabel.font;
...
- (void)newUI
{
    ...
    _takePhotoView.layer.borderColor = [UIColor colorWithRed:249/255.0 green:221/255.0 blue:108/255.0 alpha:1].CGColor;
    [self addSubview:_takePhotoView];
    
    UIImageView *takePhotoImage = [[UIImageView alloc] initWithFrame:CGRectMake(6, (_toolHeight - 6) / 2, 6, 6)];
    takePhotoImage.sakura.image(@"TKUserListView.userlist_AddFile");
    [_takePhotoView addSubview:takePhotoImage];
    
    UILabel *takePhotoLabel = [[UILabel alloc] initWithFrame:CGRectMake(_takePhotoView.width - 10 - 50, 0, 50, _toolHeight)];
//    takePhotoLabel.textColor = [UIColor colorWithRed:249/255.0 green:221/255.0 blue:108/255.0 alpha:1];
    takePhotoLabel.sakura.textColor(@"TKUserListTableView.coursewareButtonYellowColor");
    takePhotoLabel.text = MTLocalized(@"UploadPhoto.TakePhoto");
    ...
    _choosePhotoView.layer.borderColor = [UIColor colorWithRed:249/255.0 green:221/255.0 blue:108/255.0 alpha:1].CGColor;
    [self addSubview:_choosePhotoView];
    
    UIImageView *choosePhotoImage = [[UIImageView alloc] initWithFrame:CGRectMake(6, (_toolHeight - 6) / 2, 6, 6)];
    choosePhotoImage.sakura.image(@"TKUserListView.userlist_AddFile");
    [_choosePhotoView addSubview:choosePhotoImage];
    
    UILabel *choosePhotoLabel = [[UILabel alloc] initWithFrame:CGRectMake(_takePhotoView.width - 10 - 50, 0, 50, _toolHeight)];
    choosePhotoLabel.sakura.textColor(@"TKUserListTableView.coursewareButtonYellowColor");
//    choosePhotoLabel.textColor = [UIColor colorWithRed:249/255.0 green:221/255.0 blue:108/255.0 alpha:1];
    choosePhotoLabel.text = MTLocalized(@"UploadPhoto.FromGallery");
