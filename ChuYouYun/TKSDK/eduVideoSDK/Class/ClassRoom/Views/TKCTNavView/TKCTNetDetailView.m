...
- (void) changeDetailData:(id)state {
    ...
    NSString * roomID = [NSString stringWithFormat:@"%@%@", MTLocalized(@"netstate.RoomID"), [TKEduClassRoom shareInstance].roomJson.roomid];
    NSString * packetStr = MTLocalized(@"netstate.Packet");
    NSString * pingStr = MTLocalized(@"netstate.Ping");
    ...
    if ([state isKindOfClass:[TKAudioStats class]]) {
        ...
        packetStr = [NSString stringWithFormat:@"%@%.0f%@", MTLocalized(@"netstate.Packet"), packetlv * 100, @"%"];
        
        pingStr = [NSString stringWithFormat:@"%@%ldms", MTLocalized(@"netstate.Ping"), [(TKAudioStats *)state currentDelay]];
        ...
        pingStr = [NSString stringWithFormat:@"%@%ldms", MTLocalized(@"netstate.Ping"), [(TKVideoStats *)state currentDelay]];
    }
