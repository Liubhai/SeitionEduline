...
-(void)videoPopupMenuControlVideoOrCanDraw:(UIButton *)aButton aVideoRole:(TKEVideoRole)aVideoRole;//控制视频或者控制画笔根据角色判断
-(void)videoPopupMenuControlAudioOrUnderPlatform:(UIButton *)aButton aVideoRole:(TKEVideoRole)aVideoRole;//关闭音频 下讲台
-(void)videoPopupMenuControlAudio:(UIButton *)aButton aVideoRole:(TKEVideoRole)aVideoRole;//关闭音频
-(void)videoPopupMenuSendGif:(UIButton *)aButton aVideoRole:(TKEVideoRole)aVideoRole;//发送奖杯
-(void)videoPopupMenuControlVideo:(UIButton *)aButton aVideoRole:(TKEVideoRole)aVideoRole;//关闭视频
-(void)videoSplitScreenVideo:(UIButton *)aButton aVideoRole:(TKEVideoRole)aVideoRole;//演讲
...
@property (assign, nonatomic) TKEVideoRole videoRole;
