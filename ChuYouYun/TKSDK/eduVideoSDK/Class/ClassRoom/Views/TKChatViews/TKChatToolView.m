...
#define emotionWidth 20 // 表情按钮 宽度
...
- (void)layoutSubviews{
    ...
    _inputField.textContainerInset = UIEdgeInsetsMake(5, 2, 0, emotionWidth + 5);
    
    _sendButton.frame = CGRectMake(_inputField.rightX + 5, 5, sendWidth, 34.);
    
    _emotionButton.frame = CGRectMake(_inputField.rightX - emotionWidth - 5,
                                      13.,
                                      emotionWidth,
                                      emotionWidth);
