...
- (instancetype)initWithFrame:(CGRect)frame{
    if (self = [super initWithFrame:frame]) {
        ...
        _sendButton.sakura.backgroundImage(ThemeKP(@"button_send_click"),UIControlStateSelected);
        [_sendButton setTitle:MTLocalized(@"Button.jump") forState:(UIControlStateNormal)];
